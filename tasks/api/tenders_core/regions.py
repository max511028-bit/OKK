"""Коды субъектов РФ. Нужны, чтобы превращать числовые коды площадок в названия."""
from __future__ import annotations

RF_SUBJECTS: dict[str, str] = {
    ...
    "91": "Республика Крым", "92": "Севастополь", "93": "Донецкая Народная Республика",
    "94": "Луганская Народная Республика", "95": "Запорожская область",
    "96": "Херсонская область", "99": "Байконур",
}


def subject_name(code: str | int | None) -> str:
    if code is None:
        return ""
    key = str(code).strip().zfill(2)
    return RF_SUBJECTS.get(key, "")
